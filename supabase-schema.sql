...
insert into public.business_dashboard_links (title, url, category, note, icon, color, sort_order)
values
  ('Company Website', 'https://example.com', 'Company', 'Public website and brand reference.', 'W', '#146c63', 10),
  ('Shared Drive', 'https://drive.google.com', 'Documents', 'Team files, templates, and shared resources.', 'D', '#2d6396', 20),
  ('Accounting', 'https://www.xero.com', 'Finance', 'Invoices, payroll, reports, and finance admin.', '$', '#a74755', 30),
  ('Team Chat', 'https://slack.com', 'Communication', 'Daily messages, channels, and team updates.', 'C', '#b86b18', 40)
